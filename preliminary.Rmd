...
```
```{r First four models, include=TRUE}
...
```
The four models above have the sample restricted to the 80th percentile of the physical violence index among non-democracies.

```{r Next four models, include=TRUE}
...
The results above include all non-democracies.